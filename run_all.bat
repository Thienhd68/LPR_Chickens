...
chcp 65001 >nul
REM ============================================================
REM LPR System - Khởi động toàn bộ hệ thống
REM Chạy cả API Server + Detection Engine + Open Dashboard
REM ============================================================
...
REM Khởi động Flask API Server
...
REM ==================== CLEANUP ====================
REM Dừng tất cả process khi thoát
